...
uint16_t ModbusMaster232::makeWord(uint16_t w)
{
	return w;
}


uint16_t ModbusMaster232::makeWord(uint8_t h, uint8_t l)
{
	return (h << 8) | l;
}
...
uint16_t ModbusMaster232::crc16_update(uint16_t crc, uint8_t a)
    {
	int i;
...
uint16_t ModbusMaster232::crc_xmodem_update (uint16_t crc, uint8_t data)
    {
        int i;
...
uint16_t ModbusMaster232::_crc_ccitt_update (uint16_t crc, uint8_t data)
    {
        data ^= lo8 (crc);
        data ^= data << 4;
...
uint8_t ModbusMaster232::_crc_ibutton_update(uint8_t crc, uint8_t data)
    {
	uint8_t i;
